...
void DGUSScreenHandlerMKS::DGUSLCD_SendTMCStepValue(DGUS_VP_Variable &var) {
  ...
  void DGUSScreenHandlerMKS::DGUSLCD_SD_PrintAgain(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t*)val_ptr);
    switch(value)
    {
      case 0:
...
void DGUSScreenHandlerMKS::GetFeedratePercentageStep(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("\nGetFeedratePercentageStep");
  *(uint16_t *)var.memadr = swap16(*(uint16_t *)val_ptr);
}

void DGUSScreenHandlerMKS::HandleFeedratePercentageAdjust(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::GetFanPercentageStep(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::HandleFanPercentageAdjust(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::GetManualE0_T_step(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("\nGetManualE0_T_step");
  *(uint16_t *)var.memadr = swap16(*(uint16_t *)val_ptr);
}

void DGUSScreenHandlerMKS::GetManualHotB_T_step(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::Perph_page_MKS(DGUS_VP_Variable &var, void *val_ptr) {
    #if 0
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
...
uint8_t fan_from = 0;
void DGUSScreenHandlerMKS::fan_page_MKS(DGUS_VP_Variable &var, void *val_ptr) {
    #if 0
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
    switch(value) {
      case 0: 
...
void DGUSScreenHandlerMKS::print_set_page_MKS(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
    switch(value) {
      case 0: 
        print_set_from = 0;
...
void DGUSScreenHandlerMKS::PREPARE_PAGE_SET(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
    switch(value) {
...
void DGUSScreenHandlerMKS::SETTING_PAGE_JUMP(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::SETTING_TEMPER_PAGE_JUMP(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::AUTO_LEVEL_POPUP(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
...
void DGUSScreenHandlerMKS::SET_FAN_ON_OFF_HANDLER(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
...
void DGUSScreenHandlerMKS::SET_FILAMENT_DET_HANDLER(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
...
void DGUSScreenHandlerMKS::PRINT_SETTING_HANDLER(DGUS_VP_Variable &var, void *val_ptr) {
    const uint16_t value = swap16(*(uint16_t *)val_ptr);
...
void DGUSScreenHandlerMKS::SD_FileBack(DGUS_VP_Variable &var, void *val_ptr) {
  //GotoScreen(MKSLCD_SCREEN_HOME);
...
void DGUSScreenHandlerMKS::Filament_Runout_Comfirm(DGUS_VP_Variable&, void*) {
  GotoScreen(MKSLCD_SCREEN_PAUSE);
...
void DGUSScreenHandlerMKS::HandleManualE0_T(DGUS_VP_Variable &var, void *val_ptr) 
{
...
void DGUSScreenHandlerMKS::HandleManualHotB_T(DGUS_VP_Variable &var, void *val_ptr) 
{
...
void DGUSScreenHandlerMKS::HandleSetFan_MKS(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::GetLanguage_MKS(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("\nGetDefault_Temp_MKS");
  *(uint16_t *)var.memadr = swap16(*(uint16_t *)val_ptr);
}

void DGUSScreenHandlerMKS::GetDefault_Temp_MKS(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("\nGetDefault_Temp_MKS");
  *(uint16_t *)var.memadr = swap16(*(uint16_t *)val_ptr);
}

void DGUSScreenHandlerMKS::HandleSetPLAorABS_SAVE(DGUS_VP_Variable &var, void *val_ptr) {
  const int16_t value = swap16(*(int16_t*)val_ptr);
...
void DGUSScreenHandlerMKS::HandleLanguage_SAVE(DGUS_VP_Variable &var, void *val_ptr) {
	queue.inject_P(PSTR("M500"));
  GotoScreen(MKSLCD_SCREEN_SETTING);
}

void DGUSScreenHandlerMKS::HandleSetPLAorABS_MKS(DGUS_VP_Variable &var, void *val_ptr) {
  const int16_t value = swap16(*(int16_t*)val_ptr);
...
void DGUSScreenHandlerMKS::MKS_PrintFilamentLoad_Confirm(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::MKS_PrintFilamentUnLoad_Confirm(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("MKS_PrintFilamentLoad_Confirm");
  uint16_t value = swap16(*(uint16_t*)val_ptr);
  switch(value)
  {
...
void DGUSScreenHandlerMKS::MKS_PrintFilamentLoad(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::MKS_PrintFilamentUnLoad(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::MKS_FilamentCancelHeating(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::MKS_Extrude_load_popup(DGUS_VP_Variable &var, void *val_ptr) {
...
void DGUSScreenHandlerMKS::MKS_Extrude_unload_popup(DGUS_VP_Variable &var, void *val_ptr) {
  DEBUG_ECHOLNPGM("MKS_Extrude_handle");
  char buf[30];
  uint16_t value = swap16(*(uint16_t*)val_ptr);
  switch(value){
...
void DGUSScreenHandlerMKS::DGUS_Runout_reset(void) {
  runout_mks.runout_status = RUNOUT_UNCKECK;
}

void DGUSScreenHandlerMKS::DGUS_Runout_init(void) {
  runout_mks.runout_status = UNRUNOUT_STATUS;
}
...
void DGUSScreenHandlerMKS::DGUS_Runout_Idle() {
    ...
    switch (runout_mks.runout_status) {
      ...
      case RUNOUT_STATUS:
        runout_mks.runout_status = RUNOUT_WAITING_STATUS;//RUNOUT_BEGIN_STATUS;
        queue.inject(F("M25"));
        //GotoScreen(MKSLCD_SCREEN_PAUSE);
