...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  VPHELPER(VP_LEVELING_POINT_OFFSET1, &(bedlevel.z_values[0][0]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET2, &(bedlevel.z_values[0][1]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET3, &(bedlevel.z_values[0][2]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET4, &(bedlevel.z_values[0][3]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET5, &(bedlevel.z_values[1][0]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET6, &(bedlevel.z_values[1][1]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET7, &(bedlevel.z_values[1][2]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET8, &(bedlevel.z_values[1][3]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET9, &(bedlevel.z_values[2][0]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET10, &(bedlevel.z_values[2][1]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET11, &(bedlevel.z_values[2][2]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET12, &(bedlevel.z_values[2][3]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET13, &(bedlevel.z_values[3][0]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET14, &(bedlevel.z_values[3][1]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET15, &(bedlevel.z_values[3][2]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET16, &(bedlevel.z_values[3][3]), nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),  
