...
void MKS_reset_settings() {
  ...
  mks_language_index = static_cast<MKS_Language>(0);
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  VPHELPER(VP_LEVELING_POINT_OFFSET1, &LevelingBilinear::z_values[0][0], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET2, &LevelingBilinear::z_values[0][1], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET3, &LevelingBilinear::z_values[0][2], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET4, &LevelingBilinear::z_values[0][3], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET5, &LevelingBilinear::z_values[1][0], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET6, &LevelingBilinear::z_values[1][1], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET7, &LevelingBilinear::z_values[1][2], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET8, &LevelingBilinear::z_values[1][3], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET9, &LevelingBilinear::z_values[2][0], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET10, &LevelingBilinear::z_values[2][1], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET11, &LevelingBilinear::z_values[2][2], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET12, &LevelingBilinear::z_values[2][3], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET13, &LevelingBilinear::z_values[3][0], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET14, &LevelingBilinear::z_values[3][1], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET15, &LevelingBilinear::z_values[3][2], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),
  VPHELPER(VP_LEVELING_POINT_OFFSET16, &LevelingBilinear::z_values[3][3], nullptr, ScreenHandler.DGUSLCD_SendFloatAsLongValueToDisplay<2>),  
  ...
  VPHELPER(VP_TEST_TEMP1, nullptr, nullptr, ScreenHandler.DGUSLCD_SendStringToDisplay_Language),
  VPHELPER(VP_TEST_TEMP2, nullptr, nullptr, ScreenHandler.DGUSLCD_SendStringToDisplay_Language),
  VPHELPER(VP_TEST_TEMP3, nullptr, nullptr, ScreenHandler.DGUSLCD_SendStringToDisplay_Language),
  VPHELPER(VP_TEST_TEMP4, nullptr, nullptr, ScreenHandler.DGUSLCD_SendStringToDisplay_Language),
